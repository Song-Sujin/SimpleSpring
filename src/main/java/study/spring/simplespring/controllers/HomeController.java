...
public class HomeController {
	...
	*/
	...
	public String userAgent(Model model, HttpServletRequest request)	// View에게 변수를 전달하기 위해 Model 객체 정의
																		// UserAgent값을 얻기 위해 request객체 정의
	{
		...
		String browserStr = String.format("- Brower: {family=%s, patch=%s, major=%s, minor=%s}", 
